...
class Validators {
  ...
  static String searchInput(String s) {
    if (s.length < 3) {
  ...
  /// Any password validation rules can be added to this function
  ...
  static String passwordConfirmation(String val, String password) {
    if (val != password) {
